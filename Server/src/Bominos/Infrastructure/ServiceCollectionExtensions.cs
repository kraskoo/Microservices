...
{
    using Bominos.Mapping;
    using Bominos.Messages;
    using Bominos.Services.Identity;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.AddDatabase<TDbContext>(configuration)
        ...
        {
            var secret = configuration.GetSection(nameof(ApplicationSettings)).GetValue<string>(nameof(ApplicationSettings.Secret));
        ...
        public static IServiceCollection AddMessaging(this IServiceCollection services, IConfiguration configuration, params Type[] consumers)
        {
            services.AddMassTransit(mt =>
            {
                ...
                mt.AddBus(context => Bus.Factory.CreateUsingRabbitMq(rmq =>
                {
                    ...
                    rmq.UseHealthCheck(context); // Deprecated?
